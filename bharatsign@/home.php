...
<!-- 		<script language="javascript" type="text/javascript">
    ...
    <title>Bharat Crypto Sign | Template</title>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="hs-text">
                                        ...
                                        <a style="margin: 60px;" href="fir.php" class="primary-btn">File an FIR</a>
                                        <a href="viewfir1.php" style="margin:5px;" class="primary-btn">View your FIRs</a>
                                    </div>
                                </div>
                            </div>
                        </div>
