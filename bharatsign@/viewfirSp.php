...
<?php 
	...
	$sql="SELECT * from fir where area_code like '$ac' and (status like 'Reject' and last_modified_by_user_role=2) or (status like 'Accept' or 'Inprogress' and last_modified_by_user_role=3)";
